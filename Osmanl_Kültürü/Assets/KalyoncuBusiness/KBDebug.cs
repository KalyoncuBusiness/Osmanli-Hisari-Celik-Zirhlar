...
namespace KalyoncuBusiness
{
    ...
    public static class KBDebug
    {
        ...
        public static void TextPopupMouse(string text)
        {
            ...
            UtilsClass.CreateWorldTextPopup(null, text, mouseWorldPosition, 400, Color.white, new Vector3(mouseWorldPosition.x, mouseWorldPosition.y + 2), .05f);
        }
